...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Min Bot
  ${tradutor.texto1[2]} +5493585629784‬
  ${tradutor.texto1[3]} https://chat.whatsapp.com/L2noWljyBJlLaVU9uIkuf9
  ...
  const Message = {
    document: { url: `https://chat.whatsapp.com/L2noWljyBJlLaVU9uIkuf9` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://chat.whatsapp.com/L2noWljyBJlLaVU9uIkuf9",
        mediaType: 2,
        previewType: "pdf",
        title: "Min Bot",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://chat.whatsapp.com/L2noWljyBJlLaVU9uIkuf9",
      },
    },
    caption: info,
    footer: wm,
